      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center ">
        <div className="max-w-lg p-8 items-center justify-center">
          ...
          <div className="space-y-4">
            ...
            <div //Autor
              onClick={() => handleSelectRole(1)} // Selección de Autor
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                  ...
                  <img
                    src={img2}
                    alt="Author 2"
                    className="w-11 h-11 rounded-full z-10 scale-105"
                  />
                  <img src={img3} alt="Author 3" className="w-9 h-9 rounded-full" />
                </div>
                <div>
                  <span className="text-[#4338CA] font-bold text-lg font-roboto">
                    Join as an Author!
                  </span>
